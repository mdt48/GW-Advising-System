<?php
    ...
    if (isset($_SESSION['uid'])) {
            ...
            if ($row['type'] == 0 || $row['type'] == 1) {
                ...
                <?php
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $where = "audited = 1 AND grad_year is null" . $where." order by lname ".$order;
                        // echo $where;
        ...
        $query = "";
        if (strcmp($where, "") == 0){
            $query = "SELECT * FROM people JOIN student ON people.uid = student.uid audited = 1 AND grad_year is null";
        } else {
