...
insert into people (uid, username, email, birthDate, password, ssn, fname, lname, address) values (111111111, 'jlennon', 'jlennon@gmail.com', '1940-10-09', '1234', 55555555, 'John', 'Lennon', '72nd St & Central Park West, New York, NY, 10023');
...
insert into people (uid, username, email, birthDate, password, ssn, fname, lname, address) values (222111111, 'rstarr', 'rstarr@gmail.com', '1940-07-07', '1234', 66666666, 'Ringo', 'Starr', '2 Glynde Mews, Chelsea, London SW3 1SB, United Kingdom');
...
-- staff
insert into people (fname, lname, uid, username, userPassword) values ('Bhagi', 'Narahari', 1, 'bnarahari', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Admin', 'Admin', 2, 'admin', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Gabe', 'Parmer', 3, 'gparmer', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Tim', 'Wood', 4, 'twood', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Shelly', 'Heller', 5, 'sheller', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Sarah', 'Morin', 6, 'smorin', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Kevin', 'Deems', 7, 'kdeems', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Graduate', 'Secretary', 8, 'gs', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Hyeong-Ah', 'Choi', 9, 'hchoi', '1234');
insert into users (fname, lname, uid, username, userPassword) values ('Robert', 'Pless', 10, 'rpless', '1234');
